 ...
 * suppress the automatic decoding of gzipped streams. Also added experimental support for specifying a class loader when using the
...
public class Base64 {
	 ...
	 * It is important to note that data encoded this way is <em>not</em> officially valid Base64, or at the very least should not be called Base64 without also specifying that is was encoded using
